...
<fieldset>
<legend><?php echo __('Autorizaciones') ?></legend>
<?php echo $form['autorizacion_boletin']->renderRow() ?>
<?php echo $form['autorizacion_diocesis']->renderRow() ?>
</fieldset>

<fieldset>
<legend><?php echo __('Politica de privacidad') ?></legend>
<p>
<?php echo __('clausula1') ?>
</p>
<p>
<?php echo __('clausula2') ?>
</p>
<p>
<?php echo __('clausula3').' '.mail_to('voluntarios@jmj2011madrid.com') ?>
</p>
