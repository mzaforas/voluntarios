...
<h1>Voluntarios orden por niveles seguridad (excluyendo no aptos, sólo equipos con perfil "Orden")</h1>

<script type="text/javascript">
   swfobject.embedSWF(
		      "<?php echo limpiar_url(url_for('@homepage',true))?>open-flash-chart.swf", "grafica",
		      "800", "800", "9.0.0", "expressInstall.swf",
		      {"data-file":"<?php echo url_for('estadistica/seguridadDatosOrden') ?>"} );
</script>
